                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                      <form action="manage-insert.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <input type="text" name="cost" class="form-control" required="" placeholder="Average Cost for 2">
                        </div>
                        <div class="form-group">
                          <input type="text" name="cuisine" class="form-control" required="" placeholder="Cuisine Types">
                        </div>
                        <div class="form-group">
                          <input type="text" name="time" class="form-control" required="" placeholder="Timings (ex. 10:00 AM - 11:00 PM)">
                        </div>
